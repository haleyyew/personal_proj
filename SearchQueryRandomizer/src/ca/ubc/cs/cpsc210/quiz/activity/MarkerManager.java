...
public class MarkerManager {
    ...
    public void addMarkerA(LatLng latLng, String d) {

        Marker m = map.addMarker(new MarkerOptions().position(latLng).title(d).icon(BitmapDescriptorFactory.defaultMarker(getColour(0))));
        markers.add(m);
