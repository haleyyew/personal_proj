...
public class RestaurantQuiz extends Activity {
    ...
    private void setUpMap() {
        ...
        if (initializeMapObject()) {
            ...
            latLng.add(new LatLng(48.856614, 2.352222)); //Paris
            latLng.add(new LatLng(51.507351, -0.127758)); //London
            latLng.add(new LatLng(48.135125, 11.581981)); //Munich
            latLng.add(new LatLng(35.689487, 139.691706)); //Tokyo
            latLng.add(new LatLng(31.230416, 121.473701)); //Shanghai
            latLng.add(new LatLng(22.396428, 114.109497)); //Hong Kong
            latLng.add(new LatLng(1.352083, 103.819836)); //Singapore
            ...
            for (int i = 0; i < latLng.size(); i++) {
                markerManager.addMarkerA(latLng.get(i), str.get(i));
